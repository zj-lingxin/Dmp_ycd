...
object DataPrepareDao {
  def fullFieldsOrder() = {
    ...
    val orderDetailsRDD = BizDao.getOrderDetailsProps(SQL().select("cigarette_name,city,license_no,order_id,order_date,wholesale_price,need_goods_amount,order_amount,pay_money"))
      .map(a => (a(0).toString,(a(1),a(2),a(3),a(4),a(5),(6),a(7),a(8))))
